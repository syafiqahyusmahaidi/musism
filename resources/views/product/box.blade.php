        ...
        <div class="col-4 mb-2"  style="border: 3px solid black; margin-left:20px;">
            <div class="card" style="background-color: transparent;">
                ...
                <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <button class="px-4 py-2 text-white bg-blue-800 rounded" style="display:flex; align-items:center; justify-content:center; margin-left: 35%;">View Product</button>
                </form>
            </div>
        </div>
        @endforeach
